...
public class ProductController {
	...
	// =================Update masdepa==========================
		@RequestMapping(value = "/updateTotalq/{productId}/{totalq}", method = RequestMethod.PUT)
		@ResponseBody
		public int updateTotalq(@PathVariable int productId, @PathVariable int totalq) {

			int updated = productService.updateTotalq(productId, totalq);
			if (updated != 1) {
				throw new DataNotFoundException("product not updated");
			}
			return updated;
